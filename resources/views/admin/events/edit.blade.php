                    ...
                    <div class="lg:col-span-2 space-y-6">
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="title" class="block mt-1 w-full text-lg" type="text" name="title" :value="old('title', $event->title)" required autofocus />
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-1">
                                    <textarea id="description" name="description" class="block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 settings-tiny">{{ old('description', $event->description) }}</textarea>
                                </div>
                    ...
                    <div class="space-y-6">
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="start_date" class="block mt-1 w-full" type="date" name="start_date" :value="old('start_date', $event->start_date->format('Y-m-d'))" required />
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="end_date" class="block mt-1 w-full" type="date" name="end_date" :value="old('end_date', $event->end_date ? $event->end_date->format('Y-m-d') : '')" />
                            ...
                            <!-- Is Published -->
                             <div class="flex items-center mb-6">
                                <label for="is_published" class="inline-flex items-center cursor-pointer group">
                                    <input id="is_published" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="is_published" value="1" {{ old('is_published', $event->is_published) ? 'checked' : '' }}>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            ...
                            <div x-data="{ preview: '{{ $event->image ? Storage::url($event->image) : null }}' }" class="space-y-4">
