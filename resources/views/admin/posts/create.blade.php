                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6" 
                    ...
                    <div class="space-y-6 lg:sticky lg:top-24 lg:self-start">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div class="p-5">
                                <x-admin.gallery-picker name="image" label="Pilih dari Galeri" />
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div class="p-5">
                                <!-- Hidden Post Type (Since Events are handled separately) -->
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 mt-2">Kosongkan untuk publish sesuai waktu saat ini</p>
                                </div>
                            </div>
                        </div>
