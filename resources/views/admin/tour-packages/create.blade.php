            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="font-bold text-xl md:text-2xl text-gray-900 leading-tight">
                        Tambah Paket Liburan
                    </h2>
                    <p class="text-sm text-gray-500">Buat penawaran paket wisata baru</p>
                </div>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-[2rem] border border-gray-200 shadow-sm overflow-hidden p-6 md:p-8">
                ...
                <form action="{{ route('admin.tour-packages.store') }}" method="POST">
                    ...
                    <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="travel_agency_id" id="travel_agency_id" required class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                        ...
                                        @foreach($agencies as $agency)
                                            <option value="{{ $agency->id }}" {{ old('travel_agency_id') == $agency->id ? 'selected' : '' }}>{{ $agency->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" name="price_start" id="price_start" required value="{{ old('price_start') }}" min="0" step="1000"
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1 relative">
                                            <input type="number" name="duration_nights" required value="{{ old('duration_nights', 0) }}" min="0"
                                                   class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm text-center">
                                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="description" name="description" rows="4" required
                                              class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-4 placeholder-gray-400">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- SECTION 3: Itinerary -->
                        <div x-data="{
                            itinerary: {{ json_encode(old('itinerary', [['day' => 1, 'time' => '07:00', 'activity' => '']])) }},
                            addItinerary() {
